  ...
  return (
    <div className="bg-white border border-[#E8E8ED] rounded-2xl overflow-hidden hover:shadow-md transition-shadow flex flex-col ">
      ...
      <div className="p-4 ">
        ...
        <p className="text-[#0071E3] text-base font-semibold mb-4">${price}</p>

        <Link
          href={`/product/${id}`}
          className="block w-full bg-[#0071E3] hover:bg-[#0077ED] transition-colors text-white text-sm font-medium text-center py-2 rounded-lg"
        >
          Ver producto
        </Link>
      </div>
