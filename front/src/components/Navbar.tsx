    ...
    <header>
      ...
      >
        ...
        <div className="flex items-center p-2 gap-3 md:gap-5">
          ...
          <Link
            href="/cart"
            className="relative text-[#1D1D1F] hover:text-[#0071E3]"
          >
            <svg
              width="24"
              height="24"
          ...
          {user ? (
            <div className="flex items-center gap-4 md:gap-3">
              ...
              <button
                ...
                className="text-white px-3 py-2  cursor-pointer rounded-lg text-xs md:text-sm font-medium bg-[#0071E3] hover:bg-red-500 transition-colors"
              >
                Cerrar sesión
              </button>
            </div>
            ...
            <Link
              href="/auth"
              className="bg-[#0071E3] hover:bg-[#0077ed] text-white px-3 py-2 rounded-lg text-xs md:text-sm font-medium"
            >
              Iniciar sesión
            </Link>
          )}
